                ...
                <div className="hero-area flex items-center justify-center md:gap-10 gap-5 md:flex-row flex-col-reverse py-5 md:px-10 px-5">
                    ...
                    <div className="hero-content md:py-5 py-1">
                        ...
                        <div className="cta flex items-center gap-5 my-3">
                            ...
                            <Link href="#blogs" className="btn md:px-4 px-3 py-3 rounded-md mx-1 text-center hover:underline dark:bg-black dark:text-white bg-white text-black active:border active:border-2 dark:active:border-white active:border-dotted active:border-black" aria-label="Read Latest Blogs">Latest Blogs</Link>
                        </div>
