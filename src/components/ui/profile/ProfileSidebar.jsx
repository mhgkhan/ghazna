...
const ProfileSidebar = () => {
    ...
    return (
        <aside className={`${sidebarOpened ? "w-[300px]" : "w-[100px]"} overflow-hidden transition-all duration-300 h-full dark:bg-gray-900 bg-gray-200 p-2 rounded-md`}>
            ...
            <section className="aside-header my-10">
                ...
                <h2 className={`fullname text-xl text-center mx-auto my-1 font-bold ${sidebarOpened ? "block" : "hidden"}`}>Muhammad Hasnain </h2>
                <h3 className={`text-center dark:text-gray-300 text-gray-500 underline username italic ${sidebarOpened ? "block" : "hidden"}`}>@mhgkhan</h3>
                <hr />
            </section>
            <nav className="aside-nav my-3 px-4">
                <Link href="/profile" className="flex items-center gap-2 my-2 hover:text-yellow-400 transition">
                    <FaHome className={`${!sidebarOpened ? "p-2 dark:bg-gray-300 bg-gray-300 text-black font-bold rounded-md text-4xl" : ""}`} /> <span className={`${sidebarOpened ? "block" : "hidden"}`}>Dashboard</span>
                </Link>
                <Link href="/profile/myblogs/" className="flex items-center gap-2 my-2 hover:text-yellow-400 transition">
                ...
                <Link href="/profile/createblog/" className="flex items-center gap-2 my-2 hover:text-yellow-400 transition">
                ...
                <Link href="/profile/settings/" className="flex items-center gap-2 my-2 hover:text-yellow-400 transition">
                ...
                <Link href="/profile/notifications/" className="flex items-center gap-2 my-2 hover:text-yellow-400 transition">
                ...
                <Link href="/profile/saved/" className="flex items-center gap-2 my-2 hover:text-yellow-400 transition">
                ...
                <Link href="/logout/" className="flex items-center gap-2 my-2 hover:text-yellow-400 transition">
